    ...
    <div class="page-content-wrapper">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="mini-stat widget-chart-sm clearfix bg-white">
                            <span class="peity-pie float-left" data-peity='{ "fill": ["#4ac18e", "#f2f2f2"]}'
                                  data-width="60" data-height="60">0.52/1.561</span>
                        <div class="mini-stat-info text-right">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="mini-stat widget-chart-sm clearfix bg-white">
                            <span class="peity-pie float-left" data-peity='{ "fill": ["#1d1e3a", "#f2f2f2"]}'
                                  data-width="60" data-height="60">230,134</span>
                        <div class="mini-stat-info text-right">
                        ...
                        <div class="card-body">
                            ...
                            <div class="inbox-widget">
                                ...
                                <div class="text-center m-t-15">
                                    <a href="#" class="btn btn-sm btn-primary waves-light waves-effect">Load
                                        More</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <ul class="social-links list-inline mb-0">
                                        ...
                                        <li class="list-inline-item">
                                            <a title="" data-placement="top" data-toggle="tooltip" class="tooltips"
                                               href="#" data-original-title="1234567890"><i class="fa fa-phone"></i></a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a title="" data-placement="top" data-toggle="tooltip" class="tooltips"
                                               href="#" data-original-title="@skypename"><i class="fa fa-skype"></i></a>
                                        </li>
                                    </ul>
